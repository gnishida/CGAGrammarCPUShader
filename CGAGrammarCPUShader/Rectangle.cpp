...
void Rectangle::generateGeometry(float opacity, std::vector<std::vector<Vertex> >& vertices) const {
	if (_removed) return;
	...
	if (_textureEnabled) {
		vertices[offset].push_back(Vertex(glm::vec3(p1), glm::vec3(normal), glm::vec4(_color, opacity), _texCoords[0]));
		vertices[offset].push_back(Vertex(glm::vec3(p2), glm::vec3(normal), glm::vec4(_color, opacity), _texCoords[1], 1));
		vertices[offset].push_back(Vertex(glm::vec3(p3), glm::vec3(normal), glm::vec4(_color, opacity), _texCoords[2]));
		vertices[offset].push_back(Vertex(glm::vec3(p4), glm::vec3(normal), glm::vec4(_color, opacity), _texCoords[3], 1));
	} else {
		vertices[offset].push_back(Vertex(glm::vec3(p1), glm::vec3(normal), glm::vec4(_color, opacity)));
		vertices[offset].push_back(Vertex(glm::vec3(p2), glm::vec3(normal), glm::vec4(_color, opacity), 1));
		vertices[offset].push_back(Vertex(glm::vec3(p3), glm::vec3(normal), glm::vec4(_color, opacity)));
		vertices[offset].push_back(Vertex(glm::vec3(p4), glm::vec3(normal), glm::vec4(_color, opacity), 1));
	}	
}
